  ...
  const interests = [
    {
      ...
      icon: <div className="interest-icon-container software-dev">
        <span role="img" aria-label="Full-Stack Development">🌐</span>
      </div>,
      color: "#FFD700"
    },
    {
      ...
      <div className="about-main-content">
        ...
        <div className="profile-info-section">
          <p className="profile-bio">
            Hello, I'm Aziz Ekren, a 23-year-old senior (4th year) Computer Engineering student at Süleyman Demirel University,
            graduating in Summer 2026. I specialize in full-stack web and mobile application development, with a strong focus on
            building AI-powered and enterprise-grade software systems. Currently, I'm leading the development of two major projects:
            <strong> HedoraAI</strong>, an AI-driven educational analytics platform, and <strong>Terzioğlu Hukuk Sistemi</strong>,
            a comprehensive law firm management system. Both projects involve complex backend architectures, real-time data processing,
            and production Docker deployments. Check out my projects to learn more.
          </p>
